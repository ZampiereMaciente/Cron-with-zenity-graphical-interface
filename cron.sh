...
# The LGPL allows the use, modification, and redistribution of the code, provided that any modifications
# to Zenity itself are made available under the same license. However, using Zenity does not impose
# restrictions on the software that uses the tool, allowing its inclusion in proprietary projects.
